...
class Agent:
    ...
    def __init__(self, dao, uniswap_pair, xsd_token, usdc_token, **kwargs):
        ...
        if kwargs.get("is_mint", False):
            ...
            self.usdc_token.functions.mint(self.address, int(start_usdc_formatted)).transact({
...
class DAO:
    ...
    def advance(self, agent):
        before_advance = self.token_balance_of(agent.address)
        ...
        after_advance = self.token_balance_of(agent.address)
